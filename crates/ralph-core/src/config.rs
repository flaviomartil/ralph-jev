...
pub struct EventLoopConfig {
    ...
    #[serde(default)]
    pub completion_judge: Option<CompletionJudgeConfig>,
}

#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct CompletionJudgeConfig {
    #[serde(default)]
    ...
    #[serde(default = "default_judge_max_rejections")]
...
fn default_judge_max_rejections() -> u32 {
    3
}
...
impl Default for CompletionJudgeConfig {
    fn default() -> Self {
        Self {
            ...
            max_rejections: default_judge_max_rejections(),
            fail_closed: false,
        }
    }
}
