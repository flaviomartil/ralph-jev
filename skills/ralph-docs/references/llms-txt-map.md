...
The doc index is `docs/index.md` in the ralph-jev repo. There is no
...
- `docs/concepts/loop-lifecycle.md` — what happens from `run` to
  `LOOP_COMPLETE`
- `docs/concepts/completion-gate.md` — how completion is judged
...
- "What is ralph-jev?" → `docs/index.md`
...
- "How does Ralph decide the work is done?" → `docs/concepts/completion-gate.md`
- "Why did the judge reject the completion claim?" →
  `docs/concepts/completion-gate.md` + `docs/concepts/judge-evidence.md`
