...
The completion judge gets the objective directly from the loop, so it always sees the full text, in any workspace.

## Commands

```bash
ralph-jev loops          # list, inspect and manage parallel loops
ralph-jev loops --help
```
