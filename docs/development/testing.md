...
The Node suite covers the judge, the hooks and the Jev client:
...
- **Metamorphic tests**: entry order and wording don't matter, and more evidence never makes a verdict worse.
